...
function start_script() {
    ...
    find /home/dorthava/DO4_LinuxMonitoring_v2.0-1/src/02 \( ! -path /bin -o ! -path /sbin \) -type f,d -printf "%p;%Ts\n" | while read -r foil; do
    ...
    rm -rf /home/dorthava/DO4_LinuxMonitoring_v2.0-1/src/02/report.log
}
start_script "$1"